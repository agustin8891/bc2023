...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.company.bc2023.service.EmailAlreadyUsedException ||
            ex instanceof com.company.bc2023.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.company.bc2023.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.company.bc2023");
    }
}
